...
export default function FloatingContactButtons() {
  ...
  // Use props as fallback or wait until settings are loaded
  const displayPhone = settings?.phone || '+51999999999';
  const displayWhatsapp = settings?.whatsapp || '51999999999';
